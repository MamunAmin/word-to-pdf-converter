  ...
  const [src2, setSrc2] = useState("btnFile.svg");
    ...
    return (
        <div className="flex flex-col justify-center mt-8">
          <hr className="w-9/12 mx-auto border-black opacity-10"/>
          <p className="font-amethysta text-center my-6 text-[22px] text-[#0040A4] font-medium">Your <span className="text-[#DD3537] font-bold">PDF</span> is ready to download</p>
          <hr className="w-9/12 mx-auto border-black opacity-10"/>
            <button 
              onMouseOver={() => setSrc1("btnPDFHover.svg")}
              onMouseOut={() => setSrc1("btnPDF.svg")}
              className="flex flex-row mx-auto mt-24 bg-[#D33033] hover:bg-black w-[370px] rounded-[20px] shadow-boxShadow">
            ...
            <button 
              ...
              className="flex flex-row mx-auto mt-8 bg-[#295497] hover:bg-black w-[370px] rounded-[20px] shadow-boxShadow">
